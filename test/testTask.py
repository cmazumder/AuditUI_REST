...
class testTask:
    ...
    @classmethod
    def test_api_db_data(cls, api_action_address, database_object, api_datapoint_key, api_datapoint_value, test_sql_query, testname="API v/s database"):
        """
        ...
        api_result = api_util.get_api_datapoint_value(
            api_action_address=api_action_address, api_datapoint_key=api_datapoint_key, api_datapoint_value=api_datapoint_value)

        if sql_result == api_result:
            return 'Pass'
        else:
            return 'Fail'
    ...
    @classmethod
    def execute_test_steps(cls, api_action_address, database_object, table, test_sql_query, api_datapoint_key, api_datapoint_value,
        ...
        :param api_datapoint_key: to denote the key in api response
        :param api_datapoint_value: to denote the api tag containing the value of api_datapoint_key
        :param testname:
        ...
        if prereq_test_result:
            test_api_database_result = cls.test_api_db_data(api_action_address=api_action_address, database_object=database_object,
                                                            api_datapoint_key=api_datapoint_key, api_datapoint_value=api_datapoint_value,
                                                            test_sql_query=test_sql_query, testname=testname)
            logging.info('Execution of API vs database value test for %s --> %s',
            ...
            logging.info(
                'Execution of API vs database value test for %s --> BLOCKED', testname)
            return 'Fail'
